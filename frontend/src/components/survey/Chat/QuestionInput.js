            ...
            return (
                <div className="flex-1 space-y-2">
                    ...
                    {question.options?.map((option, index) => (
                        <label key={index} className="flex items-center space-x-3 p-3 hover:bg-gray-50 rounded-lg cursor-pointer border border-gray-200">
                            <input
                                type="radio"
                        ...
                        {[...Array(maxRating)].map((_, index) => {
                            ...
                            return (
                                <button
                                    ...
                                    className={`w-12 h-12 rounded-full border-2 font-semibold transition-all ${value === ratingValue.toString()
