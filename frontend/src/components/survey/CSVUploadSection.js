    ...
    <div className="bg-white rounded-lg shadow p-6">
      <div className="mb-6">
        ...
        <p className="text-gray-600 text-sm">
          Upload a CSV file containing your survey questions. Survey title, description and other
      ...
      >
        ...
        {uploadStatus === 'uploading' && (
          <>
            ...
            <p className="text-lg font-medium text-gray-900 mb-2">Processing {fileName}...</p>
            <p className="text-sm text-gray-500">Parsing questions from your CSV file</p>
          </>
        )}
      ...
      <div className="mt-6 p-4 bg-gray-50 rounded-lg">
        ...
        <div className="text-sm text-gray-600 space-y-1">
          <p>
            • <strong>Required columns:</strong> question, type
          </p>
          <p>
            • <strong>Optional columns:</strong> options, required, scale
          </p>
          <p>
            • <strong>Valid types:</strong> text, textarea, number, email, phone, date, radio,
            checkbox, dropdown, rating
          </p>
          <p>
            • <strong>Options format:</strong> Separate multiple choices with semicolons (;)
          </p>
          <p>
            • <strong>Required format:</strong> true/false or 1/0
          </p>
          <p>
            • <strong>Note:</strong> Only questions will be imported. Survey title and description
            are set separately.
          </p>
        </div>
        ...
        <div className="mt-3 p-3 bg-white rounded border">
          <p className="text-xs font-mono text-gray-700">
            ...
            <br />
            "What's your name?",text,,true
            <br />
            "Choose your department",radio,"Sales;Marketing;Engineering;HR",true
            <br />
            "Rate our service",rating,,false
            <br />
