    ...
    const parseCSV = csvText => {
        ...
        for (let i = 1; i < lines.length; i++) {
            ...
            const question = {
                ...
                required:
                    requiredIndex !== -1
                        ? values[requiredIndex]?.toLowerCase() === 'true' ||
                          values[requiredIndex] === '1'
                        : false,
            };
        ...
        <div className="bg-white rounded-lg shadow p-6">
            <div className="mb-6">
                ...
                <p className="text-gray-600 text-sm">
                    Upload a CSV file containing your survey questions. Survey title, description
            ...
            <div className="mt-6 p-4 bg-gray-50 rounded-lg">
                ...
                <div className="text-sm text-gray-600 space-y-1">
                    ...
                    <p>
                        • <strong>Valid types:</strong> text, textarea, number, email, phone, date,
                        radio, checkbox, dropdown, rating
                    </p>
                    <p>
                    ...
                    <p>
                        • <strong>Note:</strong> Only questions will be imported. Survey title and
                        description are set separately.
                    </p>
                </div>
