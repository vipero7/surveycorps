...
const SurveySidebar = ({ survey, questions, loading, onSaveDraft, onPublish }) => {
            ...
            <div className="bg-white rounded-lg shadow p-6">
                ...
                <div className="space-y-2">
                    ...
                    <div className="flex items-center justify-between">
                        <span className="text-sm text-gray-600">Questions</span>
                        <span
                            className={`text-xs ${questions.length > 0 ? 'text-green-600' : 'text-red-600'}`}
                        >
                            {questions.length > 0 ? '✓' : '✗'}
                        </span>
                    </div>
                    <div className="flex items-center justify-between">
                        ...
                        <span
                            className={`text-xs ${canPublish ? 'text-green-600' : 'text-red-600'}`}
                        >
                            {canPublish ? '✓' : '✗'}
                        </span>
                    </div>
