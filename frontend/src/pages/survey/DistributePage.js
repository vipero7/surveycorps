      ...
      <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-600 mb-4">Copy and share this link with your respondents</p>
          ...
          <div className="border-t pt-6">
            <h3 className="text-lg font-medium text-gray-900 mb-4">Send Email Invitations</h3>
